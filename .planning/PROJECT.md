...
- [ ] Двухуровневая структура папок vault (8 корневых + подпапки, 27 папок + attachments)
- [ ] Двухуровневая inline-навигация: выбор категории → подкатегория (или сразу сохранение)
- [ ] Кнопка Inbox для быстрого сохранения без категоризации
- [ ] Теги предлагаются после выбора папки, зависят от категории, необязательны
...
- **UX**: Новая двухуровневая навигация (категория → подкатегория), отличается от текущего мультиселекта хэштегов
...
| Двухуровневая навигация вместо мультиселекта хэштегов | 8 корневых категорий → подпапки. Теги отделены от папок, необязательны. Inbox для быстрого сохранения. | — Pending |
| 27 папок в vault | Бизнес(7), Ландшафт(3), ТОС(3), Семья(2), Рецепты(4), Новости, Идеи, Inbox + attachments | — Pending |
